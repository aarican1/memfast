...
import 'package:memfast/ui/game_over/game_over_page.dart';
import 'package:memfast/ui/level_complete/level_complete_page.dart';
...
class GamePage extends StatelessWidget {
  const GamePage({super.key, required this.buttonCount});
  ...
  void setList(MediaQueryData mediaQueryData, int widgetCount) {
    buttonOffsetList = generateRandomButtonOffset(
      mediaQueryData,
      widgetCount,
      mediaQueryData.size.width * 0.11,
      mediaQueryData.size.width * 0.11,
    );
  }
    ...
    for (int i = 0; i < widgetCount; i++) {
      if (hasChild(i)) {
        ...
        positionChild(
          i,
          Offset(
            GamePage.buttonOffsetList[i].dx,
...
List<Widget> buildButtonWidget(MediaQueryData mediaQuery, int widgetCount) {
